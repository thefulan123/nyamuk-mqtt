...
import pytest
from nyamuk.core.log_parser import LogParser, LogLevel, LogEntry
...
class TestLogParser:
    ...
    def test_filter_logs_by_search(self):
        ...
        entries = [
            LogEntry(timestamp="2024-01-15T10:30:00", level=LogLevel.INFO, message="Client connected"),
            LogEntry(timestamp="2024-01-15T10:30:01", level=LogLevel.INFO, message="Client disconnected"),
            LogEntry(timestamp="2024-01-15T10:30:02", level=LogLevel.INFO, message="Message published"),
        ]
    ...
    def test_get_unique_clients(self):
        ...
        entries = [
            LogEntry(timestamp="2024-01-15T10:30:00", level=LogLevel.INFO, message="Client connected", client_id="ESP32-001"),
            LogEntry(timestamp="2024-01-15T10:30:01", level=LogLevel.INFO, message="Client connected", client_id="ESP32-002"),
            LogEntry(timestamp="2024-01-15T10:30:02", level=LogLevel.INFO, message="Client connected", client_id="ESP32-001"),
        ]
